...
For details please see `Control which apps appear in the Dashboard Navbar <1-4-dashboard-navbar-config>`_.
...
.. _1-4-dashboard-navbar-config: https://osc.github.io/ood-documentation/release-1.4/customization.html#dashboard-navbar-config
