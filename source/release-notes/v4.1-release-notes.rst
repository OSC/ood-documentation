...
* ``pddro-Vestas`` made their first contribution in `OSC/ood_core#865 <https://github.com/OSC/ood_core/pull/865>`_
* ``andrejcermak`` made their first contribution in `OSC/ood_core#871 <https://github.com/OSC/ood_core/pull/871>`_
* ``tat-ohmura`` made their first contribution in `OSC/ood_core#883 <https://github.com/OSC/ood_core/pull/883>`_
* ``dev-sda1`` made their first contribution in `OSC/ood_core#914 <https://github.com/OSC/ood_core/pull/914>`_
* ``kwkoepcke3`` made their first contribution in `OSC/ood_core#916 <https://github.com/OSC/ood_core/pull/916>`_

* ``romulojales`` made their first contribution in `OSC/ood-documentation#980 <https://github.com/OSC/ood-documentation/pull/980>`_
* ``rwxayheee`` made their first contribution in ood-documentation
* ``jennyfothergill`` made their first contribution in ood-documentation 
* ``ndjones`` made their first contribution in ood-documentation
* ``bpaynter`` made their first contribution in ood-documentation 
* ``aharral`` made their first contribution in ood-documentation
* ``jinyuhan`` made their first contribution in ood-documentation
* ``saracook`` made their first contribution in ood-documentation
* ``Pennswood`` made their first contribution in ood-documentation
* ``davidecarlson`` made their first contribution in ood-documentation
