...
* ``andrejcermak`` made their first contribution in ood_core  
* ``kwkoepcke3`` made their first contribution in ood_core
* ``dev-sda1`` made their first contribution in ood_core
* ``tat-ohmura`` made their first contribution in ood_core
* ``pddro-Vestas`` made their first contribution in ood_core
* ``romulojales`` made their first contribution in ood-documentation
